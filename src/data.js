export const PrimiPlatti=[
    {
        id:Math.random(),
        title:"CACIO & PEPI TONNARELLI , PECORINO CHEESE AND PARMIGIANO REGGIANO",
        price:90+"QAR",
        description:"aaaaaaaaa",
        img:"https://res.cloudinary.com/mealthy1/image/upload/ar_16:11,c_fill,f_auto,h_760,q_auto:best,w_1140/v1527363921/cms_recipe_featured_image/h3g7mf8ylim7ldymkjnv.jpg"
    },
    {
        id:Math.random(),
        title:"CRUSTACEAN LINGUINI, CONT TOMATOES , LEMON AND BASIL",
        price:115+"QAR",
        description:"aaaaaaaaaa",
        img:"https://www.marhaba.qa/wp-content/uploads/2022/08/SEA-BREAM-scaled.jpg"
    },
...
export const Teams=[
    {
        ...
        img:"https://media.istockphoto.com/photos/smiling-businesswoman-looking-at-camera-webcam-make-conference-call-picture-id1129638608?k=20&m=1129638608&s=612x612&w=0&h=AUoSDsGI9b-f_izlotPYpYb1nQ34YUvIlU6S4B1zJug=",
    ...
    },
    {
        ...
        career:"All new cafe/chef managers start training through our support team model. After training, the support manager may be assigned to their own café location."
    ...
    },
    {
        ...
        phone:"33 000 000",
        email:"amal.benAli@gmail.com",
        img:"https://img.freepik.com/free-photo/portrait-dark-skinned-cheerful-woman-with-curly-hair-touches-chin-gently-laughs-happily-enjoys-day-off-feels-happy-enthusiastic-hears-something-positive-wears-casual-blue-turtleneck_273609-43443.jpg?w=2000",
